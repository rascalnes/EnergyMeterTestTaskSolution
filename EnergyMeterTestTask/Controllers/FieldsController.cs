...
namespace EnergyMeterTestTask.Controllers
{
    ...
    public class FieldsController : ControllerBase
    {
        ...
        public IActionResult GetAllFields() => Ok(_fieldService.GetAllFields());
        ...
        {
            var distance = _fieldService.CalculateDistanceToCenter(id, new GeoPoint(lat, lng));
        ...
        {
            var result = _fieldService.CheckPointInFields(new GeoPoint(lat, lng));
